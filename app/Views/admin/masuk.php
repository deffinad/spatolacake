        ...
        <div class="form-container flex-grow-1 d-flex justify-content-center align-items-center flex-row gap-5">
            <div class="form-body">
                ...
                <div class="form-content">
                    <form action="<?= base_url('masukadmin/')?>" method="POST">
                        <h1 class="fw-bold mb-5">Masuk Admin</h1>
                        <div class="mb-3">
                            <input type="text" class="form-control fs-8" name="email" placeholder="Masukan Email" required/>
                        </div>

                        <div class="mb-3">
                            <input type="password" class="form-control fs-8" name="password" placeholder="Masukan Password" required/>
                        </div>
                        <button class="button button-black my-4 p-2" type="submit" name="submit" style="width: 100%; border-radius: 20px">
                            Masuk
                        </button>
                    </form>
                </div>
