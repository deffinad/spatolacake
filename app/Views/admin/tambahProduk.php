        ...
        <div id="content">
            <div class="content-main">
                ...
                if ($input) {
                    ...
                    if (array_key_exists('fotoKue', $input)) {
                        $fotoKue = $input['fotoKue'];
                    }
                ...
                <div class="content-box">
                    <form action="<?= base_url('kelolaproduk/tambah') ?>" method="POST" enctype="multipart/form-data">
                        <div class="row detail mb-3">
                            <div class="col-4">
                                <label for="inputId" class="form-label">ID Kue</label>
                                <input type="text" class="form-control" name="idKue" value="<?= $id ?>" readonly />
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row detail mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <div class="d-flex flex-row gap-3">
                                    <img src="#" id="previewProduk" alt="foto kue" class="rounded d-none" style="width: 120px; height: 120px;">

                                    <div class="d-flex flex-grow-1 align-items-center" style="height: 120px;">
                                        <input type="file" class="form-control" name="fotoKue" value="<?= $fotoKue ?>" onchange="previewGambar(this);" />
                                    </div>
                                </div>
                        ...
                        <div class="d-flex mt-4 justify-content-end">
                            <button class="button button-green px-5 py-2" type="submit" name="simpanProduk">Kirim</button>
                        </div>
                    </form>
                </div>
            </div>
