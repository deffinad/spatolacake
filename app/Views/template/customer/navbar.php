<nav class="navbar navbar-expand-lg fixed-top header-transparent" id="header">
  <div class="container-fluid">
    ...
    <a href="<?= base_url('/') ?>" class="navbar-brand d-flex align-items-center justify-content-center">
      <img src="<?= base_url('assets/images/sc1.png') ?>" alt="Logo Spatola Cake" width="140" height="140">
    </a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link scrollto <?php if ($_SESSION['route'] == 'landingPage') {
                                        echo 'active';
                                      } ?> fw-bold" href="<?= base_url('/') ?>">Beranda</a>
        </li>
        <li class="nav-item">
          <a class="nav-link scrollto <?php if ($_SESSION['route'] == 'tentang') {
                                        echo 'active';
                                      } ?> fw-bold" href="<?= base_url('/tentang') ?>">Tentang</a>
        </li>
        <li class="nav-item">
          <a class="nav-link scrollto <?php if ($_SESSION['route'] == 'katalog') {
                                        echo 'active';
                                      } ?> fw-bold" href="<?= base_url('/katalog') ?>">Katalog</a>
        </li>
        <li class="nav-item">
          <a class="nav-link scrollto <?php if ($_SESSION['route'] == 'riwayatPemesanan') {
                                        echo 'active';
                                      } ?> fw-bold" href="<?= base_url('/riwayatpemesanan') ?>">Pesanan Saya</a>
        </li>
        <li class="nav-item">
          <a class="nav-link scrollto <?php if ($_SESSION['route'] == 'kontak') {
                                        echo 'active';
                                      } ?> fw-bold" href="<?= base_url('/kontak') ?>">Kontak</a>
        </li>
      </ul>
